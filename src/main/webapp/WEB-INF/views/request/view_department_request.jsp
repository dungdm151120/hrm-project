                            ...
                            <div class="dashboard-main">
                                ...
                                <div class="dashboard-content">
                                    <div class="search-filter">
                                        <form action="${pageContext.request.contextPath}/view_department_request"
                                            method="GET">
                                            ...
                                            <select name="status" onchange="this.form.submit()">
                                                <option value="" ${empty selectedStatus ? 'selected' : '' }>All Status
                                                </option>
                                            ...
                                            <select name="type" onchange="this.form.submit()">
                                                <option value="" ${empty selectedType ? 'selected' : '' }>All Types
                                                </option>
                                            ...
                                            <a href="${pageContext.request.contextPath}/view_department_request${not empty selectedDeptId ? '?deptId='.concat(selectedDeptId) : ''}"
                                                class="btn-reset">Clear</a>
                                        </form>
                                    </div>
                                        ...
                                        <table>
                                            ...
                                            <tbody>
                                                <c:forEach items="${requestList}" var="req" varStatus="r">
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <c:choose>
                                                                <c:when test="${req.type == 'OVERTIME'}">
                                                                    <jsp:useBean id="otDao_dept"
                                                                        class="dao.OvertimeRequestDAO" />
                                                                    <br><small style="color: #666;">Date:
                                                                        ${otDao_dept.getByRequestId(req.id).overtimeDate}</small>
                                                                </c:when>
                                                        ...
                                                        <td>${req.proposerName}</td>
                                                         <td>
                                                             <span class="badge badge-${fn:toLowerCase(req.status)}">${req.status}</span>
                                                         </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <div class="actions">
                                                                <a href="request_detail?id=${req.id}&from=dept&deptId=${selectedDeptId}"
                                                                    class="btn-secondary">View Detail</a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </c:forEach>
                                                <c:if test="${empty requestList}">
                                                    <tr>
                                                        <td colspan="6"
                                                            style="text-align: center; color: #666; font-style: italic; padding: 15px;">
                                                            No requests found for this department.</td>
                                                    </tr>
                                                </c:if>
                                            </tbody>
                                        </table>
