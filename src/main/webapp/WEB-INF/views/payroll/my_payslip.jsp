...
<head>
    ...
    <title>My Payslip Detail | HRM</title>
    ...
    <div class="dashboard-main">
        ...
        <div class="dashboard-header" style="margin-bottom: 8px;">
            <div class="header-left">
                <h1 class="header-title" style="font-size: 1.3rem;">My Payslip Detail</h1>
            </div>
        ...
        <div class="dashboard-content">
            ...
            <div style="margin-bottom: 8px;">
                <a class="back-link" href="${pageContext.request.contextPath}/payroll/my" style="font-size: 0.8rem;">
