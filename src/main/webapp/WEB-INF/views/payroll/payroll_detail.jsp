        ...
        <form action="${pageContext.request.contextPath}/payroll/confirm" method="post">
            ...
            <div class="dashboard-content">
                <div style="display: flex; justify-content: space-between; align-items: center; width: 100%; margin-bottom: 20px;">
                    <a class="back-link" href="${pageContext.request.contextPath}/payroll/list?departmentId=${param.departmentId}&month=${param.month}&year=${param.year}" style="margin: 0;">
                ...
                <c:if test="${statusLower == 'draft' && userPermissions.contains('PAYROLL_CONFIRM')}">
                     <div style="text-align: right; margin-top: 20px;">
                          <button type="submit" class="btn btn-primary" style="padding: 12px 30px; font-size: 1rem; font-weight: bold;">Confirm</button>
                     </div>
                </c:if>
            </div>
        </form>
