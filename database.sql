...
CREATE TABLE attendance_lock_log (
                                     ...
                                     year INT NOT NULL,
                                     department_id INT,
                                     action VARCHAR(50) NOT NULL COMMENT 'DEPT_CONFIRM, HR_FINALIZE, SNAPSHOT_CREATED',
                                     user_id INT NOT NULL,
                                     note TEXT,
                                     created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
                                     FOREIGN KEY (user_id) REFERENCES users(id),
...
CREATE TABLE payrolls (
                          ...
                          sick_leave_pay BIGINT NOT NULL DEFAULT 0,
...
CREATE TABLE payroll_settings (
                                  id INT AUTO_INCREMENT PRIMARY KEY,
                                  employee_social_insurance DECIMAL(5, 2) DEFAULT 8.0,
                                  employee_health_insurance DECIMAL(5, 2) DEFAULT 1.5,
                                  employee_unemployment_insurance DECIMAL(5, 2) DEFAULT 1.0,
                                  employee_union DECIMAL(5, 2) DEFAULT 1.0,
                                  company_social_insurance DECIMAL(5, 2) DEFAULT 17.5,
                                  company_health_insurance DECIMAL(5, 2) DEFAULT 3.0,
                                  company_unemployment_insurance DECIMAL(5, 2) DEFAULT 1.0,
                                  company_union DECIMAL(5, 2) DEFAULT 2.0,
                                  ot_weekday_rate DECIMAL(5, 2) DEFAULT 150.0,
                                  ot_weekend_rate DECIMAL(5, 2) DEFAULT 200.0,
                                  ot_holiday_rate DECIMAL(5, 2) DEFAULT 300.0,
...
CREATE TABLE leave_dates (
                             ...
                             CONSTRAINT uq_leave_dates_request_date UNIQUE (leave_request_id, leave_date),
                             CONSTRAINT fk_leave_dates FOREIGN KEY (leave_request_id) REFERENCES leave_requests(id) ON DELETE CASCADE
);
...
INSERT INTO users (
    ...
    hire_date, employment_status, active
      ...
      ('EMP001', 'Nguyễn Minh Quân', 'admin@company.com', '$2a$12$i2YrvBXFtSROiHGPzs/9leZJySfJv7vD0bi81.PDpTevFej3al.zu', '0900000001', 'Male', '1998-01-10 00:00:00', 'Hà Nội', NULL,
       (SELECT id FROM roles WHERE name = 'SYSTEM ADMIN'), NULL, NULL, '2024-01-01', 'WORKING', TRUE),
      ('EMP018', 'Nguyễn Minh Quân', 'minhquan.it@company.com', '$2a$12$i2YrvBXFtSROiHGPzs/9leZJySfJv7vD0bi81.PDpTevFej3al.zu', '0900000018', 'Male', '1998-01-10 00:00:00', 'Hà Nội', NULL,
      ...
      ('EMP002', 'Trần Đức Anh', 'ducanh.it@company.com', '$2a$12$i2YrvBXFtSROiHGPzs/9leZJySfJv7vD0bi81.PDpTevFej3al.zu', '0900000002', 'Male', '2000-03-15 00:00:00', 'Đà Nẵng', NULL,
      ...
      ('EMP003', 'Phạm Gia Huy', 'giahuy.it@company.com', '$2a$12$i2YrvBXFtSROiHGPzs/9leZJySfJv7vD0bi81.PDpTevFej3al.zu', '0900000003', 'Male', '2001-07-20 00:00:00', 'Hồ Chí Minh', NULL,
      ...
      ('EMP004', 'Lê Hoàng Nam', 'hoangnam.it@company.com', '$2a$12$i2YrvBXFtSROiHGPzs/9leZJySfJv7vD0bi81.PDpTevFej3al.zu', '0900000004', 'Male', '1999-11-05 00:00:00', 'Hà Nội', NULL,
      ...
      ('EMP005', 'Nguyễn Thu Hà', 'hrmanager@company.com', '$2a$12$i2YrvBXFtSROiHGPzs/9leZJySfJv7vD0bi81.PDpTevFej3al.zu', '0900000005', 'Female', '1995-02-12 00:00:00', 'Hà Nội', NULL,
      ...
      ('EMP006', 'Trần Mai Anh', 'maianh.hr@company.com', '$2a$12$i2YrvBXFtSROiHGPzs/9leZJySfJv7vD0bi81.PDpTevFej3al.zu', '0900000006', 'Female', '1999-04-18 00:00:00', 'Hà Nội', NULL,
      ...
      ('EMP007', 'Phạm Ngọc Linh', 'ngoclinh.hr@company.com', '$2a$12$i2YrvBXFtSROiHGPzs/9leZJySfJv7vD0bi81.PDpTevFej3al.zu', '0900000007', 'Female', '2000-08-25 00:00:00', 'Hồ Chí Minh', NULL,
      ...
      ('EMP008', 'Vũ Hải Yến', 'haiyen.hr@company.com', '$2a$12$i2YrvBXFtSROiHGPzs/9leZJySfJv7vD0bi81.PDpTevFej3al.zu', '0900000008', 'Female', '2001-12-03 00:00:00', 'Đà Nẵng', NULL,
      ...
      ('EMP009', 'Đỗ Quang Huy', 'payrollmanager@company.com', '$2a$12$i2YrvBXFtSROiHGPzs/9leZJySfJv7vD0bi81.PDpTevFej3al.zu', '0900000009', 'Male', '1994-06-09 00:00:00', 'Hồ Chí Minh', NULL,
      ...
      ('EMP010', 'Nguyễn Thảo Vy', 'thaovy.payroll@company.com', '$2a$12$i2YrvBXFtSROiHGPzs/9leZJySfJv7vD0bi81.PDpTevFej3al.zu', '0900000010', 'Female', '2000-09-14 00:00:00', 'Hồ Chí Minh', NULL,
      ...
      ('EMP011', 'Bùi Minh Khang', 'minhkhang.payroll@company.com', '$2a$12$i2YrvBXFtSROiHGPzs/9leZJySfJv7vD0bi81.PDpTevFej3al.zu', '0900000011', 'Male', '1998-10-22 00:00:00', 'Hà Nội', NULL,
      ...
      ('EMP012', 'Lê Phương Anh', 'phuonganh.payroll@company.com', '$2a$12$i2YrvBXFtSROiHGPzs/9leZJySfJv7vD0bi81.PDpTevFej3al.zu', '0900000012', 'Female', '2001-05-17 00:00:00', 'Đà Nẵng', NULL,
      ...
      ('EMP013', 'Hoàng Minh Đức', 'salesmanager@company.com', '$2a$12$i2YrvBXFtSROiHGPzs/9leZJySfJv7vD0bi81.PDpTevFej3al.zu', '0900000013', 'Male', '1993-03-30 00:00:00', 'Hà Nội', NULL,
      ...
      ('EMP014', 'Nguyễn Khánh Ly', 'khanhly.sales@company.com', '$2a$12$i2YrvBXFtSROiHGPzs/9leZJySfJv7vD0bi81.PDpTevFej3al.zu', '0900000014', 'Female', '2000-07-11 00:00:00', 'Hồ Chí Minh', NULL,
      ...
      ('EMP015', 'Trần Quốc Bảo', 'quocbao.sales@company.com', '$2a$12$i2YrvBXFtSROiHGPzs/9leZJySfJv7vD0bi81.PDpTevFej3al.zu', '0900000015', 'Male', '1999-01-28 00:00:00', 'Đà Nẵng', NULL,
      ...
      ('EMP016', 'Phan Bảo Long', 'businessadmin@company.com', '$2a$12$i2YrvBXFtSROiHGPzs/9leZJySfJv7vD0bi81.PDpTevFej3al.zu', '0900000016', 'Male', '1996-08-22 00:00:00', 'Hà Nội', NULL,
       (SELECT id FROM roles WHERE name = 'BUSINESS ADMIN'), NULL, NULL, '2024-04-01', 'WORKING', TRUE),
      ('EMP017', 'Đặng Thanh Hương', 'payroll@company.com', '$2a$12$i2YrvBXFtSROiHGPzs/9leZJySfJv7vD0bi81.PDpTevFej3al.zu', '0900000017', 'Female', '1997-05-14 00:00:00', 'Hồ Chí Minh', NULL,
...
INSERT INTO pit_bracket_versions (version_name, effective_date)
VALUES ('Biểu thuế TNCN 2026', '2026-01-01');

INSERT INTO pit_brackets (version_id, bracket_level, min_value, max_value, tax_rate) VALUES
                                                                                         (1, 1, 0, 10000000, 5.0),
                                                                                         (1, 2, 10000001, 30000000, 10.0),
...
INSERT INTO permissions (code, name, description) VALUES
                                                      ...
                                                      ('TASK_VIEW_ALL', 'View all tasks', 'Can view all tasks in the system'),
...
-- BUSINESS ADMIN (all permissions except attendance confirmation)
INSERT INTO role_permissions (role_id, permission_id)
SELECT r.id, p.id FROM roles r CROSS JOIN permissions p
WHERE r.name = 'BUSINESS ADMIN'
  AND p.code NOT IN ('ATTENDANCE_CONFIRM_DEPT', 'ATTENDANCE_FINALIZE_HR');
